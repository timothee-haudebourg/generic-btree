...
impl<K, L, V, W> PartialOrd<Binding<L, W>> for Binding<K, V>
where
    K: PartialOrd<L>,
    V: PartialOrd<W>,
{
...
impl<K, L, V, W> PartialEq<Binding<L, W>> for Binding<K, V>
where
    K: PartialEq<L>,
    V: PartialEq<W>,
{
